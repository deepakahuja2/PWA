                                ...
                                echo '<tr>
                                    ...
                                    <td class="text-center">
                                        <div class="row mx-auto" style="width:112px">
                                            <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#editUser' .$Id. '" type="button"style = "background-color:black;color:#FFA45B;border:black;">Edit</button>';
                                            if($Id == 1) {
                                                echo '<button class="btn btn-sm btn-danger"  style="margin-left:9px; background-color:black;color:#FFA45B;border:black;">Delete</button>';
                                            }
                                            else {
                                                echo '<form action="partials/_userManage.php" method="POST">
                                                        <button name="removeUser" class="btn btn-sm btn-danger" style="margin-left:9px;background-color:black;color:#FFA45B;border:black;">Delete</button>
