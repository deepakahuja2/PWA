                            ...
                            while($row=mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#reply' .$contactId. ' "style = "background-color:black;color:#FFA45B;border:black;">Reply</button>
                                        </td>
                                    </tr>';
                            }
                            if($count==0) {
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="partials/_contactManage.php" method="post">
                ...
                <button type="submit" class="btn btn-success" name="contactReply"  style = "background-color:black;color:#FFA45B;border:black;">Reply</button>
            </form>
          </div>
        </div>
      </div>
