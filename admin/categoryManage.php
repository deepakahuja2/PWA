                ...
                <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="createCategory" class="btn btn-sm btn-primary col-sm-3 offset-md-4" style="background-color:black;color: #FFA45B; border:black;"> Create </button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button class="btn btn-sm btn-primary edit_cat" type="button" data-toggle="modal" data-target="#updateCat' .$catId. '" style="background-color:black;color: #FFA45B; border:black;">Edit</button>
                                            <form action="partials/_categoryManage.php" method="POST">
                                                <button name="removeCategory" class="btn btn-sm btn-danger"  style=" margin-left:9px; background-color:black;color: #FFA45B; border : black;"">Delete</button>
